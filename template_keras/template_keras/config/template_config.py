...
class TemplateConfiguration(ABC):
    ...
    @abstractmethod
    def metrics(self):
        raise NotImplementedError("Property should contain the metrics to print.")
    ...
    def train_generator(self):
        raise NotImplementedError("Property should contain the train generator. To be instanciated with prepare_training_generators().")

    @property
    @abstractmethod
    def validation_generator(self):
        raise NotImplementedError("Property should contain the validation generator. To be instanciated with prepare_training_generators().")

    @property
    @abstractmethod
    def test_generator(self):
        raise NotImplementedError("Property should contain the test generator. To be instanciated with the prepare_testing_generators().")
